...
On an M1 MacBook, until an `issue <https://github.com/inveniosoftware/invenio-assets/issues/144>`_ with
`Invenio-Assets <https://github.com/inveniosoftware/invenio-assets>`_ is addressed, you will need to replace
