...
# Define a global DataFileValidator object variable
# so that when custom schemas are only loaded once
CACHED_DATA_VALIDATOR = None


def get_submission_validator(old_hepdata):
    """
    ...
    return submission_file_validator
